...
#%%
plot_adLoad <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = adload_norm, color = tg)) +
    geom_line() +
...
plot_subs <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = sub_norm, color = tg)) +
    geom_line() +
...
plot_numAds <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = num_ads, color = tg)) +
    geom_line() +
...
plot_allHours <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = all_hours_norm, color = tg)) +
    geom_line() +
...
plot_activity <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = activity_norm, color = tg)) +
    geom_line() +
...
plot_adSuppHours <- ggplot(data = agg_plots[tg %in% c("3x1","6x3")], aes(x = time_period, y = ad_supported_hours_norm, color = tg)) +
    geom_line() +
...
ggsave("./Data_generate/agg_plots.png", height = 11.5, width = 11)
ggsave("./Data_generate/agg_plots.eps",height =  11.5, width = 11)
